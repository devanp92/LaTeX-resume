...
\schoolwithcourses{B.S. Computer Science Engineering, Mathematics}{University of Florida}{Expected Graduation: Spring 2015}{
\begin{courses}
	...
	\course{Mathematics}{Multivariable Calculus $\cdot$ Complex Analysis $\cdot$ Analysis $\cdot$ Abstract Algebra $\cdot$ Combinatorics $\cdot$ Computational Linear Algebra}
\end{courses}}
