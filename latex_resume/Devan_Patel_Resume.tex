...
\newcommand{\contact}[5]
	{\begin{center}
		{\LARGE \scshape{#1}}\\
		\Telefon \hspace{0.5ex} #3 \hspace{1em} \Letter \hspace{0.5ex} #4 \hspace{1em} \faGithub \hspace{0.5ex} #5 \hspace{1em} \Mundus \hspace{0.5ex} devanpatel.me
...
\begin{courses}
	\course{Computer Science}{Operating Systems $\cdot$  Data Structures $\cdot$  Algorithms $\cdot$ Database and Information Systems $\cdot$ Object Oriented Principles $\cdot$ Concurrent Programming $\cdot$ Computer Organization}
	\course{Mathematics}{Multivariable Calculus $\cdot$ Complex Analysis $\cdot$ Analysis $\cdot$ Abstract Algebra $\cdot$ Combinatorics $\cdot$ Linear Algebra}
\end{courses}}
...
\employer{Goldman Sachs Group, Inc.}{Technology Analyst Intern, New York, NY}{2013 - 2013}{
	\begin{achievements}
	...
	\item{Designed API to integrate with global Operations Technology teams cross divisionally.\kt Java, Groovy, R, DB2, JMX, JUnit, Maven, JIRA}

	\end{achievements} 
}

\employer{Rokk3r Labs}{Startup Fellow and Project Manager, Miami Beach, FL}{2014 - 2014}{
\begin{achievements}

\item{Managed a team of developers to develop a proprietary full stack enterprise agile project management tool to be used by all divisions.}

\item{Conducted technology analysis for machine learning, computer vision, and big data in order to design prototype for several clients' investment pitches. \kt Angular.js, Sails,js, Node.js, Javascript, CSS, HTML5, MongoDB, Redis, Selenium, Mocha, Jasmine, Heroku, Git}
