...
\schoolwithcourses{B.S. Computer Science Engineering, Mathematics}{University of Florida}{}{
\begin{courses}
    ...
    \course{Mathematics}{Analysis $\cdot$ Complex Analysis $\cdot$ Analysis $\cdot$ Abstract Algebra $\cdot$ Combinatorics $\mathrm{I \& II}$ $\cdot$ Combinatorial Theory $\cdot$ Multivariable Calculus $\cdot$ Probability Theory $\cdot$ Numerical Analysis $\cdot$ Computational Linear Algebra} 
\end{courses}
}
